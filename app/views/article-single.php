<article class="single-post-article bg-slate-900" id="article-<?= $props['id'] ?>">
    <div class="content-hero" style="background-image: linear-gradient(0deg, rgba(0,0,0,.75), rgba(0,0,0,.75)), url('https://cdn-2.photovaliant.com/photovaliant/uploads/<?= $props['featured_image'] ?>');">
    ...
    <div class="post-content container mx-auto lg:max-w-4xl p-8 tracking-tight bg-slate-800 rounded-md">
        <?= $props['content_html'] ?>
    </div>
</article>
